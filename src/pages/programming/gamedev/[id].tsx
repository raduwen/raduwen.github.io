...
import type { PostEntity, PostWithoutBodyEntity, PostElement } from '@/domain/gamedev-diary/entity';
    ...
    <>
      ...
      <Box mb="16">
        <Board>
          ...
          <Text fontSize="xs" textAlign="right" mt={4}>{format(new Date(post.date), 'yyyy/MM/dd HH:mm', { timeZone: 'Asia/Tokyo' })}</Text>
